...
You will also need to create a free Trello account and an API Key and Token as the project uses the Trello REST API.
Trello account: https://trello.com/signup
Trello API Key and Token: 
1. Create a new custom Power-Up: https://developer.atlassian.com/cloud/trello/guides/power-ups/managing-power-ups/#adding-a-new-custom-power-up
...
The below section should then be added to the `.env` file with the API Key and Token you have just generated.
